...
TEST_GROUPS = [
    {
        ...
        "cases": [
            ...
            {"id": "G1-03", "msg": "帮我写一段小红书种草文案",
             "goal": "生成小红书平台营销文案", "expect": ["content_skill"],
             "primary": "content_skill", "must_contain": [],
             "fix_keywords": {"content_skill": ["种草", "小红书"]}},
    ...
    },
    {
        ...
        "cases": [
            {"id": "G2-01", "msg": "SKU-A001快缺货了，看看这个商品的销量",
             ...
             "primary": "inventory_skill", "must_contain": []},
            {"id": "G2-02", "msg": "写一段双11促销文案",
             "goal": "生成促销文案(不应误入定价/审批流)",
             "expect": ["content_skill"], "primary": "content_skill",
             "must_not_contain": ["审批"],
             "fix_keywords": {"content_skill": ["促销文案"]}},
    ...
    },
    {
        ...
        "cases": [
            ...
            {"id": "G4-03", "msg": "帮我写一首关于秋天的诗",
             ...
             "expect": ["unknown", "content_skill"], "primary": "unknown",
