...
class VectorStore:
    ...
    def load_embeddings(self):
        ...
        if config.USE_LOCAL_EMBEDDING:
            ...
            try:
                ...
                if path:
                    ...
                    logger.warning(
                        "Model cache missing, loading online"
                    )
        ...
        try:
            ...
            logger.error(
                "DashScope embedding failed: %s",
                e
            )   


            logger.info(
                "API embedding loaded"
            )
